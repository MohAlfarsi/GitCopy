...
namespace GitCopy.Controllers
{
    ...
    public class PostsController : ControllerBase
    {
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<ServiceResponse<List<Post>>>> GetSingle(int id)
        {
        ...
        [HttpPost]
        public async Task<ActionResult<ServiceResponse<List<Post>>>> AddPost(Post newPost)
        {
